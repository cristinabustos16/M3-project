...
# qsub -cwd -V -S /usr/bin/python -q fast.master.q@compute-0-2 -t 1-10 -l mem_token=2000M,mem_free=2000M launch_array_pca.py
import os, sys
...
if __name__ == '__main__':
    ...
    cmd_mask = "python try_PCA_full.py %s %s"
