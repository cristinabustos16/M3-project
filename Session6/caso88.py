...
x = ZeroPadding2D((1,1),input_shape=(3,224,224))(inputs)
x = Convolution2D(32, 5, 5, activation='relu', border_mode='valid', subsample=(2, 2), name='conv1')(x)
x = MaxPooling2D((2, 2), strides=(2, 2), name='pool1')(x)
x = ZeroPadding2D((1,1))(x);
x = Convolution2D(64, 5, 5, activation='relu', border_mode='valid', subsample=(2, 2), name='conv3')(x)
...
#optimizer = Adam(lr=0.01, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0)
...
name_accuracy_plot = 'accuracy_2.jpg'
name_loss_plot = 'loss_2.jpg'
